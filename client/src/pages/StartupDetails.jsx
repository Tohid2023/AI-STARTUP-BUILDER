...
export default function StartupDetails() {
  ...
  const handleSave = async () => {
    try {
      const res = await axios.patch(`${import.meta.env.VITE_API_URL}/api/startup/${id}/save`, {}, {
        headers: { Authorization: "Bearer " + localStorage.getItem("token") },
      });
  ...
  const handleRegenerate = async () => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/startup/${id}/regenerate`, {}, {
        headers: { Authorization: "Bearer " + localStorage.getItem("token") },
      });
